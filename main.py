...
closed_eyes_gif = "assets/ani.gif"
...
while True:
    ...
    if results.multi_face_landmarks:
        ...
        if eyes_closed:
            reaction_mode = "eyes"
            cv2.putText(frame, "jobapplication.png", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
        elif tongue_out:
            reaction_mode = "tongue"
            cv2.putText(frame, "nice try diddy", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 2)
        else:
            reaction_mode = None
            cv2.putText(frame, "liberal ahh face", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 2)
    ...
    if reaction_mode == "eyes" and eyes_frames:
        ...
        cv2.putText(blank, "blud u aint freaky", (30, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (200,200,200), 2)
